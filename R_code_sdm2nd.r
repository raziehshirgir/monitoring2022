...
system.file("external/species.shp",) and we should put the name of th package too.
...
# list the predictors
list.files <- list.files(path=path,pattern='asc$',full.names = T) #
lst
